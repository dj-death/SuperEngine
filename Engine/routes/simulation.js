...
var Q = require('q');
var MarketSim = require('../engine/ComputeEngine/Environnement/src/Market');
var SimMain = require('../simulation/Main');
...
function objectSlice(object, startIdx, endIdx) {
    var slice = {};
...
function divideObject(object, packetSize, persistentKey, persistentValue) {
    var keys = Object.keys(object);
    var size = keys.length;
...
function run(req, res, next) {
    ...
    loadCompaniesData(seminarId, groupId, period, function (companies) {
        ...
        loadLastState(function (data) {
            ...
            p.then(function (states) {
                console.debug('step 2');
                return setIntelligenceInfos(companies);
