...
function getImprovementType(str) {
...
function initEnvironnemet(lastState, currPeriod) {
...
exports.initEnvironnemet = initEnvironnemet;
function simulateEnv() {
    o.europe.simulate();
    o.northAmerica.simulate();
    o.materialMarket.simulate();
}
exports.simulateEnv = simulateEnv;
function initialize(lastState, currPeriod, CID) {
    ...
    // materials
    o.rmWarehouse.init(lastState.material_closingQ, lastState.materialsInventoriesValue, lastState.material_deliveryNextPBoughtBeforeLastPQ, 0, lastState.purchases_3mthQ * 1000, 0, lastState.purchases_6mthQ * 1000, 0);
    o.supplier.init(o.material, o.materialMarket);
    ...
    o.alphaA.init(o.atelierMoulage, o.material, o.alphaASubContracter, lastState.p1_components_availableNextPQ, 0);
    ...
    o.alphaB.init(o.atelierMoulage, o.material, o.alphaBSubContracter, lastState.p2_components_availableNextPQ, 0);
    ...
    o.alphaC.init(o.atelierMoulage, o.material, o.alphaCSubContracter, lastState.p3_components_availableNextPQ, 0);
...
function setDecisions(dec, lastState) {
    // machines decisions
    ...
    function tryProgram(p1_Q, p2_Q, p3_Q) {
...
exports.setDecisions = setDecisions;
function getOrders(matrix) {
...
exports.getEndState = getEndState;
